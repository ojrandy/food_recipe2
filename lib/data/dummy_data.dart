...
const availableCategories = [
  ...
  Category(
    id: 'c11',
    title: 'Summer',
    color: Color.fromARGB(255, 112, 201, 28),
  ),
  Category(id: 'c12', title: 'Winter', color: Color.fromARGB(255, 2, 6, 221)),
  Category(id: 'c13', title: 'Spring', color: Color.fromARGB(255, 241, 74, 8)),
...
final dummyMeals = [
  ...
  Meal(
    ...
    complexity: Complexity.simple,
    imageUrl:
        'https://b2366945.smushcdn.com/2366945/wp-content/uploads/2021/08/toast-sml-3.jpg?lossy=1&strip=1&webp=1',
    duration: 10,
    ingredients: [
      '1 Slice White Bread',
      '1 Slice Ham',
  ...
  Meal(
    ...
    complexity: Complexity.simple,
    imageUrl:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTKzqnG45BC5ASuNzAzwnNWzZ9Vw_VJqYLjdA&s',
    duration: 45,
    ingredients: [
      '300g Cattle Hack',
      '1 Tomato',
  ...
  Meal(
    ...
    imageUrl:
        'https://www.allrecipes.com/thmb/cLaK8eoUtaPs9j0mraE6LTrV1U4=/0x512/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/78117-wienerschnitzel-ddmfs-3X4-0200-ec06b882b575486ab7398957709413d2.jpg',
    duration: 60,
    ingredients: [
      '8 Veal Cutlets',
      '4 Eggs',
  ...
  Meal(
    ...
    affordability: Affordability.luxurious,
    complexity: Complexity.simple,
    imageUrl: 'https://shorturl.at/Vy3Ak',
    duration: 15,
    ingredients: [
      'Arugula',
      'Lamb\'s Lettuce',
  ...
  Meal(
    ...
    imageUrl: 'https://shorturl.at/Itc6P',
    duration: 240,
    ingredients: [
  ...
  Meal(
    ...
    affordability: Affordability.affordable,
    complexity: Complexity.simple,
    imageUrl: 'https://shorturl.at/C0Ieq',
    duration: 20,
    ingredients: [
  ...
  Meal(
    ...
    affordability: Affordability.pricey,
    complexity: Complexity.challenging,
    imageUrl: 'https://shorturl.at/usXwW',
    duration: 35,
    ingredients: [
      '4 Chicken Breasts',
      '1 Onion',
  ...
  Meal(
    ...
    complexity: Complexity.hard,
    imageUrl:
        'https://www.allrecipes.com/thmb/qFgD7M9N-J3JsRKmRFq9fP3zuU8=/0x512/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/257193-chef-johns-chocolate-souffle-DDMFS-beauty-4x3-57-0af04de9f4154f44b0d927dab4d2e624.jpg',
    duration: 45,
    ingredients: [
  ...
  Meal(
    ...
    complexity: Complexity.simple,
    imageUrl:
        'https://bigdeliciouslife.com/wp-content/uploads/2025/04/Marinated-Asparagus-7.jpg',
    duration: 30,
    ingredients: [
